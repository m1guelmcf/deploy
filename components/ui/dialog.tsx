...
// Root (não precisa de wrapper com forwardRef)
...
// Portal (não repassamos ref — Portal não expõe ref)
    ...
    >
      ...
      {showCloseButton && (
        <DialogPrimitive.Close
          ...
          className={cn(
            // observe as aspas internas em selectors trocadas para evitar conflito
